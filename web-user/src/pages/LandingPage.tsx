    ...
    <div className="min-h-screen flex flex-col transition-colors duration-300 bg-white dark:bg-gray-900">
      ...
      >
        ...
        <div className="max-w-6xl mx-auto grid gap-8 md:grid-cols-3">
          <div className="bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 p-6 rounded-xl shadow hover:shadow-lg transition">
      ...
      {/* Call to Action */}
      <section className="py-20 px-4 bg-blue-600 dark:bg-indigo-700 text-white text-center transition-colors duration-300">
      ...
      {/* Footer */}
      <footer className="bg-gray-200 dark:bg-gray-900 text-gray-800 dark:text-gray-200 text-center py-6 transition-colors duration-300">
